...
export class ConferenceComponent implements OnInit {
  ...
  onClick(selectedSchool: School): void {
    if (this.dataService.getSelectedSchool() !== undefined) {
      ...
      } else if (this.dataService.getSelectedSchool()?.conferenceId === selectedSchool.conferenceId && this.dataService.getSelectedSchool()?.divisionId === selectedSchool.divisionId) {
